...
/**
 * @ngdoc service
 * @name anzacMockupApp.ellwood
 * @description
 * # ellwood
 * Factory in the anzacMockupApp.
 */
angular.module('anzacMockupApp')
    .factory('ellwood', function() {
        // Service logic
        // ...
        ...
        var ellwood = {
            timeline: {
                'timeline': {
                    ...
                    'date': [{
                        ...
                        'headline': 'c. 1957',
                        'text': '<p>‘Burnley’ is sold to Ron McNicol (Doris Ellwood’s cousin) reportedly for a total of 12,000 pounds. The two blocks were sold separately – 160 acres of vacant land and the other block which included a house.</p>',
                        'startDate': 'c. 1957'
                    }, {
                        'headline': '1961',
                        'text': '<p>The three portions of land at Gordonbrook (which are still leasehold) are sold to Mr Bill Woltmann.  He is the father of Bob Ellwood’s daughter-in-law June Ellwood.</p>',
                        'startDate': '1961'
                    }, {
                        'headline': '1964',
                        'text': '<p>Bob and Doris Ellwood retire permanently to Bribie Island after building a new home on Welsby Parade overlooking the Pumicestone Passage.</p>',
                        'startDate': '1964'
                    }, {
                        'headline': '1970',
                        'text': '<p>June Ellwood inherits the three portions at Gordonbrook on the death of her father.</p>',
                        'startDate': '1970'
                    }, {
                        'headline': '1971',
                        'text': '<p>Doris Ellwood dies on 12 July in St Andrew’s Hospital Wickham Tce Brisbane of angina, aged 69[iv].</p>',
                        'startDate': '1971'
                    }, {
                        'headline': '1973',
                        'text': '<p>Alan and June Ellwood inherit portion 336 ‘Tahiti’ at Memerambi from Alan’s aunt, Miss Anna Beatrice Ellwood.  They also acquire the other portion (337) of ‘Tahiti’ from Bob Ellwood who forgave the cost in lieu of the improvements (contouring, sheds, equipment etc.) made by and paid for by Alan and June since their arrival on site after their October 1954 marriage.</p>',
                        'startDate': '1973'
                    }, {
                        'headline': '1979',
                        'text': '<p>Bob Ellwood sells his Welsby Parade home and moves to a purpose built house at ‘Davlyn’, the property of Alan and June Ellwood at Memerambi.  His unmarried daughter, Rita, shares the home and cares for him.  ‘Tahiti’ had been renamed ‘Davlyn’ in honour of the children of Alan and June Ellwood – David and Lynn.</p>',
                        'startDate': '1979'
                    }, {
                        'headline': '1980',
                        'text': '<p>June Ellwood sells Gordonbrook.</p>',
                        'startDate': '1980'
                    }, {
                        'headline': '1988',
                        'text': '<p>Bob Ellwood dies at home at Memerambi of cancer on 21 June, aged 93.</p><p>Funeral services are held in the Uniting Church Kingaroy on 24 June and later that day in the Chapel of the Albany Creek Crematorium, Aspley, Brisbane.  His ashes are placed alongside those of his wife, Doris, at the Albany Creek Crematorium.</p>',
                        'startDate': '1988'
                    }, {
                        'headline': '2008',
                        'text': '<p>The ashes of Bob and Doris Ellwood are taken back to the South Burnett District and placed in the garden of the Taabinga Garden Cemetery outside Kingaroy.</p>',
                        'startDate': '2008'
                    }],
                    'era': []
                }
            ...
            bio: {
                ...
                'married': {
                    'date': '1 October 1921',
                    'place': 'Albert St Methodist Church, Brisbane',
                    'spouse': 'Doris Jane McNicol'
                },
                'children': [{
                    'name': 'Rita',
                    'born': {
                    ...
                    'married': {
                        'date': '8 March 1954',
                        'spouse': 'Noela Faye Searle'
                    }
                }, {
                    'name': 'Patricia Beatrice',
                    'born': {
                        'date': '4 October 1927',
                        'place': 'Kingaroy'
                    },
                    'married': {
                        'date': '26 March 1949',
                        'spouse': 'Frederick Harry REED'
                    }
                }, {
                    'name': 'Alan Roy',
                    'born': {
                        'date': '26 January 1931',
                        'place': 'Kingaroy'
                    },
                    'married': {
                        'date': '2 October 1954',
                        'spouse': 'Margaret June Woltmann'
                    }
                }]
            }
        };
